    ...
    return {
      ...
      '<div class="birdyard-menu-wrapper">' +
        ...
        '<div ng-if="signedIn" class="birdyard-btn pointer" style="padding-bottom: 0; height: 33px; width: 33px; text-align: center; overflow: hidden;" ng-click="toggleMenu()">' + 
          '<i class="icon fa fa-navicon menu" ng-if="notificationCount == 0" style="font-size: 20px;"></i>' + 
          '<i class="icon fa fa-bell co-yellow menu ding" ng-if="notificationCount > 0" ng-class="{\'ring\': ring}" style="font-size: 20px; text-shadow: 0px 1px 0px rgba(0,0,0,0.5);"></i>' +
        '</div>' +
